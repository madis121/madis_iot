...
public class ControlsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("[ControlsServlet] " + Utils.getCurrentTime() + " Heater status: " + heaterSwitch);
		System.out.println("[ControlsServlet] " + Utils.getCurrentTime() + " Light status: " + lightSwitch);
	}
